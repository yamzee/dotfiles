...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/yamtheme"
-- theme.wallpaper                                 = theme.dir .. "/wp/art_41.png"
theme.wallpaper                                 = os.getenv("HOME") .. "/.wallp" -- new wallpaper directory, universal with things like sway and all.
